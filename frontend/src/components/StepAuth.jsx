  ...
  return (
    ...
    <div className="bg-white/70 backdrop-blur-2xl w-full max-w-md rounded-[2.5rem] shadow-[0_20px_50px_-12px_rgba(0,0,0,0.08)] border border-white/60 overflow-hidden transition-all duration-500 hover:shadow-2xl">
      ...
      {authPhase === 'initial' ? (
        ...
        /* OTP Entry Phase - Replaces initial inputs entirely */
        <div className="p-8 space-y-8 animate-in fade-in slide-in-from-right-4 duration-500">
          ...
          <div className="space-y-6">
            <div className="text-center space-y-2">
              ...
              <p className="text-sm text-slate-600">Check your {activeTab === 'mobile' ? 'SMS' : 'email'} for the 6-digit code</p>
            </div>
            ...
            <button
              ...
              disabled={loading}
              className="w-full mt-6 pt-6 border-t border-slate-100 text-slate-600 text-sm font-semibold hover:text-primary transition-colors py-4"
            >
